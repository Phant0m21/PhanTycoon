...
class NavigationView(disnake.ui.View):
    ...
    @disnake.ui.button(label="Mine", emoji="⛏️", style=disnake.ButtonStyle.primary, custom_id="nav:mine")
    async def mine(self, button, inter):
        from phantycoon.cogs.mine import run_mine
        await run_mine(inter)

    @disnake.ui.button(label="Profile", emoji="👤", style=disnake.ButtonStyle.primary, custom_id="nav:profile")
    ...
    @disnake.ui.button(label="Quests", emoji="📜", style=disnake.ButtonStyle.primary, custom_id="nav:quests")
    ...
    @disnake.ui.button(label="Shop", emoji="🛒", style=disnake.ButtonStyle.primary, custom_id="nav:shop")
